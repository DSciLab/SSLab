...
from .base import MoCoV3BaseTrainer
from ssl_lab.network.resnet import ResNet
from ssl_lab.network.mocov3.mocov3 import MoCo_ResNet


__all__ = ['MoCoV3ResNet50SSLTrainer']


@mod.register('arch')
class MoCoV3ResNet50SSLTrainer(MoCoV3BaseTrainer):
    @gen.synchrony
    ...
    def train_step(self, item):
        ...
        loss, feat = self.net(images1, images2, self.moco_m)
