...
from .base import MoCoV2BaseTrainer
from ssl_lab.network.resnet import ResNet
from ssl_lab.network.mocov2.mocov2 import MoCo_ResNet


__all__ = ['MoCoV2ResNet50SSLTrainer']


@mod.register('arch')
class MoCoV2ResNet50SSLTrainer(MoCoV2BaseTrainer):
    @gen.synchrony
